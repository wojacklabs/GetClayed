...
export class FixedKeyUploader {
  ...
  constructor() {
    ...
    console.log('[FixedKeyUploader] NEXT_PUBLIC_IRYS_PRIVATE_KEY exists:', !!process.env.NEXT_PUBLIC_IRYS_PRIVATE_KEY);
    console.log('[FixedKeyUploader] Key length:', process.env.NEXT_PUBLIC_IRYS_PRIVATE_KEY?.length || 0);
