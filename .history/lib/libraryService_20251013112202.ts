...
// Library contract ABI (simplified for now)
export const LIBRARY_CONTRACT_ABI = [
  "function registerAsset(string projectId, string name, string description, uint256 price) external",
  "function purchaseAsset(string projectId) external payable",
  "function getAsset(string projectId) external view returns (tuple(string projectId, string name, string description, uint256 price, address currentOwner, address originalCreator, uint256 totalRevenue, uint256 purchaseCount, uint256 listedAt, bool isActive))",
  ...
  "function updateAssetPrice(string projectId, uint256 newPrice) external"
];
...
export interface LibraryAsset {
  ...
  name: string;
  description: string;
  price: string; // in IRYS tokens (wei)
  currentOwner: string;
