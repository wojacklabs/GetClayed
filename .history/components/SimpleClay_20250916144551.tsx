...
import { Move3d, MousePointer, RotateCw, Circle, Eraser, SwitchCamera } from 'lucide-react'
import { SplinePointer } from '@/lib/customIcons'
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Pull Clay"
            >
              <Circle size={16} className="scale-125" />
            </button>
          </div>
        </div>
      </div>
