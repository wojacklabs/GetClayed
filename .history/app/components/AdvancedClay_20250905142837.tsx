...
function AddClayHelper({ 
  ...
  useEffect(() => {
    ...
    const getIntersectionPoint = (e: MouseEvent): THREE.Vector3 | null => {
      ...
      // Calculate the point at current depth along camera direction from camera position
      ...
      // The plane normal should point towards the camera (opposite of camera direction)
