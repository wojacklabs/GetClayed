    ...
    <group>
      ...
      {tool === 'rotate' && (
        <group position={[0, 0, 0]}>
          {/* XZ horizontal plane at origin for rotate tool */}
          <mesh rotation={[-Math.PI / 2, 0, 0]}>
            <planeGeometry args={[200, 200, 100, 100]} />
            <meshBasicMaterial 
              color="#4a90e2" 
          ...
          <mesh>
            ...
            <meshBasicMaterial color="#ff0000" /> {/* X axis - Red */}
          </mesh>
          <mesh>
            <boxGeometry args={[0.05, 200, 0.05]} />
            <meshBasicMaterial color="#00ff00" /> {/* Y axis - Green */}
          </mesh>
          <mesh>
            <boxGeometry args={[0.05, 0.05, 200]} />
            <meshBasicMaterial color="#0000ff" /> {/* Z axis - Blue */}
          </mesh>
        </group>
      )}
    </group>
