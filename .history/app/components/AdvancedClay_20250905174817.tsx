      ...
      <group ref={cameraGroup}>
        {(tool === 'move' || tool === 'add' || tool === 'push' || tool === 'pull') && (
          <group position={[0, -5, -30]}>
            ...
            <group>
              {/* X axis - Red */}
              <arrowHelper args={[new THREE.Vector3(1, 0, 0), new THREE.Vector3(0, 0, 0), 25, 0xff0000, 5, 2]} />
              {/* Y axis - Green */}
              <arrowHelper args={[new THREE.Vector3(0, 1, 0), new THREE.Vector3(0, 0, 0), 25, 0x00ff00, 5, 2]} />
              {/* Z axis - Blue */}
              <arrowHelper args={[new THREE.Vector3(0, 0, 1), new THREE.Vector3(0, 0, 0), 25, 0x0000ff, 5, 2]} />
            </group>
          </group>
        )}
      </group>
