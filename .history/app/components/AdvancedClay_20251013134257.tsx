...
export default function AdvancedClay() {
  ...
  const handleImportFromLibrary = async (asset: any) => {
    ...
    try {
      // Purchase the asset
      const { purchaseLibraryAsset } = await import('../../lib/libraryService')
      const purchaseResult = await purchaseLibraryAsset(asset.projectId, parseFloat(asset.price))
        ...
        <div className="fixed inset-0 bg-black/50 z-[10000] flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-gray-700 mb-2">Price (IRYS)</label>
                <input
                  type="number"
                  step="0.01"
                  value={libraryPrice}
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  disabled={!libraryAssetName || !libraryPrice || parseFloat(libraryPrice) <= 0}
