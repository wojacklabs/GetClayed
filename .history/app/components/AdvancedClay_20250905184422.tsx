      ...
      <group ref={cameraGroup}>
        {(tool === 'move' || tool === 'add' || tool === 'push' || tool === 'pull') && (
          <group position={[0, -10, -40]}>
            ...
            {[-20, -10, 0, 10, 20].map((y, index) => (
              <group key={`xz-plane-${index}`} rotation={[-Math.PI / 2, 0, 0]} position={[0, y, 0]}>
                {/* Grid lines for each plane */}
                <lineSegments>
                  <edgesGeometry args={[new THREE.PlaneGeometry(60, 60, 20, 20)]} />
                  <lineBasicMaterial 
                    color={y === 0 ? "#666666" : "#cccccc"} 
                    transparent 
                    opacity={y === 0 ? 0.6 : 0.3}
                  />
                </lineSegments>
            ...
            <group>
              {/* X axis - Red */}
              <mesh>
                <boxGeometry args={[60, 0.5, 0.5]} />
                <meshBasicMaterial color="#ff0000" />
              </mesh>
              
              {/* Y axis - Green */}
              <mesh>
                <boxGeometry args={[0.5, 60, 0.5]} />
                <meshBasicMaterial color="#00ff00" />
              </mesh>
            ...
            {/* Axis labels */}
            <group>
              <Text position={[32, 0, 0]} fontSize={3} color="#ff0000">X</Text>
              <Text position={[0, 32, 0]} fontSize={3} color="#00ff00">Y</Text>
              <Text position={[0, 0, 32]} fontSize={3} color="#0000ff">Z</Text>
            </group>
