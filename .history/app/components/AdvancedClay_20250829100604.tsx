...
import ClayGroup from './ClayGroup'
        ...
        >
          <Suspense fallback={null}>
            ...
            {clayObjects.map(clay => {
              ...
              return (
                <group key={clay.id} ref={groupRef} position={clay.position}>
                  <Clay
                    clay={{...clay, position: new THREE.Vector3(0, 0, 0)}}
                    tool={tool}
                    brushSize={brushSize}
                  ...
                  />
                  {tool === 'move' && selectedClayId === clay.id && groupRef.current && (
                    <TransformControls
