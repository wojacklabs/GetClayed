    ...
    <div className="w-full h-full flex">
      ...
      <div className="w-72 bg-white shadow-lg p-4 overflow-y-auto">
        ...
        <div className="text-xs text-gray-500 mt-6">
          ...
          <p>• Select Rotate View to move camera</p>
          <p>• Select sculpting tool to modify clay</p>
          <p>• Click and drag on clay to sculpt</p>
          <p className="mt-2 font-semibold">Tips:</p>
          <p>• Only one tool active at a time</p>
          <p>• Switch to Rotate View anytime</p>
        </div>
      </div>
