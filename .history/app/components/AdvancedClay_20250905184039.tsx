        ...
        <mesh
          ...
          onPointerDown={(e) => {
            if (tool === 'move' && meshRef.current && groupRef.current) {
              ...
              // Disable camera controls while moving
              onDeformingChange(true)
              // Set parent's moveDragRef if available
              if (window.moveDragRef) {
                window.moveDragRef.current = true
              }
            }
          }}
      ...
      <group ref={cameraGroup}>
        {(tool === 'move' || tool === 'add' || tool === 'push' || tool === 'pull') && (
          <group position={[0, -10, -40]}>
            ...
            {/* Primary planes with transparency */}
            {/* XY plane (Z=0) - Front plane */}
            <mesh position={[0, 0, 0]}>
