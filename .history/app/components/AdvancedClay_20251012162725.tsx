    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if ((e.metaKey || e.ctrlKey) && e.key === 'v') {
        ...
        if (clipboardRef.current.clay) {
          ...
          // Clone the geometry
          const clonedGeometry = clipboardRef.current.clay.geometry.clone()
          ...
          const newClay: ClayObject = {
            ...
            position: new THREE.Vector3(
              clipboardRef.current.clay.position.x + 0.5,
              clipboardRef.current.clay.position.y,
              clipboardRef.current.clay.position.z + 0.5
            ),
            rotation: clipboardRef.current.clay.rotation ? new THREE.Euler(
              clipboardRef.current.clay.rotation.x,
              clipboardRef.current.clay.rotation.y,
              clipboardRef.current.clay.rotation.z
            ) : new THREE.Euler(),
            scale: clipboardRef.current.clay.scale instanceof THREE.Vector3 
              ? new THREE.Vector3(clipboardRef.current.clay.scale.x, clipboardRef.current.clay.scale.y, clipboardRef.current.clay.scale.z)
              : clipboardRef.current.clay.scale,
