    ...
    const handleMouseDown = (e: MouseEvent) => {
      ...
      if (shape === 'sphere') {
        ...
        if (clickPoints.length === 0) {
          ...
          // Get camera orientation and calculate tilted plane basis
          const cameraDirection = new THREE.Vector3()
          camera.getWorldDirection(cameraDirection)
          ...
          // Calculate tilted plane normal (same as grid)
          ...
          if (shape === 'tetrahedron' || shape === 'cube') {
            ...
            center.add(planeNormal.clone().negate().multiplyScalar(shapeHeight / 2))
          }
