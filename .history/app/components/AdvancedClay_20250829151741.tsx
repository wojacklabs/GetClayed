      ...
      if (shape === 'sphere') {
        ...
        if (clickPoints.length < 3) {
          ...
          if (clickPoints.length === 2) {
            // Create shape after 3rd click
            const [p1, p2] = [...clickPoints, point]
            const width = Math.abs(p2.x - p1.x) || 2
            const depth = Math.abs(p2.z - p1.z) || 2
            const height = Math.abs(point.y - p1.y) || 2
            ...
            const thickness = height / size // Relative thickness
