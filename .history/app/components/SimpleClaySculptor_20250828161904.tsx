...
export default function SimpleClaySculptor() {
  ...
  const [tool, setTool] = useState<'push' | 'pull' | 'smooth' | 'paint'>('push')
  ...
  return (
    <div className="w-full h-full flex">
      ...
      <div className="w-72 bg-white shadow-lg p-4 overflow-y-auto">
        ...
        {/* Tools */}
        <div className="mb-6">
          <h3 className="text-sm font-semibold mb-2">Sculpting Tools</h3>
        ...
        {isDeforming && (
          <div className="mb-4 p-2 bg-yellow-100 rounded text-xs">
            <p className="font-semibold">Sculpting Mode Active</p>
            <p>Camera rotation disabled</p>
          </div>
        )}
        
        {/* Instructions */}
        <div className="text-xs text-gray-500 mt-6">
          <p className="font-semibold mb-1">How to Sculpt:</p>
          <p>• Click and drag to deform</p>
          <p>• Push Out: Add volume</p>
          <p>• Pull In: Remove volume</p>
          <p>• Smooth: Soften edges</p>
          <p>• Rotate view: Right click + drag</p>
          <p className="mt-2 text-orange-600">• Camera rotation auto-disabled while sculpting</p>
        </div>
      </div>
