...
function DynamicGridHelper({ tool, selectedClayId, clayObjects, hoveredPoint, onCoordsUpdate }: {
  ...
  return (
    <group>
      {/* Camera-space group for planes */}
      <group ref={cameraGroup}>
        {/* Global camera-aligned XZ plane in camera space */}
        ...
        {tool === 'move' && clayObjects.map((clay) => {
          ...
          const cameraSpaceY = relativePos.dot(cameraUp)
          const cameraSpaceZ = -relativePos.dot(cameraDir)
          
          // Calculate depth for color mapping
          ...
          return (
            <mesh 
              key={clay.id} 
              position={[cameraSpaceX, cameraSpaceY, -cameraSpaceZ]}
              rotation={[-Math.PI / 2, 0, 0]}
            >
      ...
      {/* Camera-aligned XZ plane for push, pull tools */}
      ...
      {/* Camera-aligned XZ plane for add tool */}
