...
export default function AdvancedClay() {
  ...
  const [tool, setTool] = useState<'rotate' | 'push' | 'paint' | 'add' | 'move'>('rotate')
  ...
  return (
    <div className="h-screen bg-gray-100 relative">
      ...
      {/* Bottom Toolbar */}
      <div className="absolute bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm shadow-lg">
        ...
        {tool === 'move' && selectedClayId && (
          <div className="mb-6">
            ...
            <div className="text-xs text-gray-500 p-2 bg-gray-100 rounded">
              ...
              <p>• Click & drag clay to move freely in 3D</p>
              <p>• <span className="font-semibold text-blue-600">Scroll: Adjust depth (Z-axis)</span></p>
              <p>• <span className="text-gray-600">Scroll works when selected or dragging</span></p>
              <p className="mt-1 font-semibold">Keyboard shortcuts:</p>
