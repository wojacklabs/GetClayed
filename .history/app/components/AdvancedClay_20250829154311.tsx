...
function AddClayHelper({ 
  ...
  useEffect(() => {
    ...
    const getIntersectionPoint = (e: MouseEvent): THREE.Vector3 | null => {
      ...
      // Project camera direction to horizontal plane and get perpendicular
      const horizontalDir = new THREE.Vector3(cameraDirection.x, 0, cameraDirection.z).normalize()
      const planeNormal = new THREE.Vector3(0, 1, 0) // Keep using horizontal plane for now
      
      // For grid helper, we'll use y=0 plane
