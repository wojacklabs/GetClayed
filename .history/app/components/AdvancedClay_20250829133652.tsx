...
function Clay({ 
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      if (!dragState.current.active || tool !== 'move' || !isSelected) return
      
      e.preventDefault()
      
      // Adjust depth based on scroll
      const scrollSpeed = 0.01
      dragState.current.currentDepth += e.deltaY * scrollSpeed
    }
        ...
        {tool === 'move' && selectedClayId && (
          <div className="mb-6">
            ...
            <div className="text-xs text-gray-500 p-2 bg-gray-100 rounded">
              ...
              <p>• <span className="font-semibold text-blue-600">Scroll while dragging: Adjust depth (Z-axis)</span></p>
              <p>• Mouse follows camera-facing plane</p>
