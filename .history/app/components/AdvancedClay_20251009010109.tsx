  ...
  useEffect(() => {
    ...
    const handleToolMouseMove = (e: MouseEvent) => {
      if (tool === 'rotateObject' && rotationRef.current.active && meshRef.current) {
        ...
        // For now, only support single object rotation
        // TODO: Implement group rotation properly
          ...
          if (tool === 'rotateObject' && isSelected && meshRef.current) {
            ...
            if (clay.groupId && clayGroups) {
              ...
              if (group) {
                ...
                // For now, disable group rotation to fix build error
                // TODO: Implement group rotation properly
              }
            } else {
...
export default function AdvancedClay() {
  ...
  }, [selectedForGrouping, clayGroups, addToHistory, showPopup])
    ...
    <div className="h-screen bg-gray-100 flex flex-col">
      ...
      <div className="bg-white shadow-lg border-t border-gray-200">
        <div className="flex flex-col">
          ...
          {showGroupingPanel && (
            <div className="border-t border-gray-200 px-4 py-2 flex items-center justify-center gap-4">
              {/* Shape selection - centered like other tools */}
              <div className="flex items-center gap-2">
