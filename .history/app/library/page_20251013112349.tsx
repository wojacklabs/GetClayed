...
import { queryLibraryAssets, purchaseLibraryAsset, LibraryAsset } from '@/lib/libraryService'
...
export default function LibraryPage() {
  ...
  const handlePurchase = async (asset: LibraryAsset) => {
    if (!walletAddress) {
    ...
    try {
      const result = await purchaseLibraryAsset(asset.projectId, parseFloat(asset.price))
      if (result.success) {
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              {filteredAssets.map((asset) => (
                <div key={asset.projectId} className="bg-white rounded-lg overflow-hidden hover:shadow-md transition-shadow border border-gray-200 group">
                  {/* Thumbnail */}
                  <div 
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500 mb-2">
                      ...
                      <span className="font-semibold text-gray-900">{asset.price} IRYS</span>
                    </div>
                    <button
                      onClick={() => handlePreview(asset)}
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50">
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{previewAsset.price} IRYS</p>
                </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => handlePurchase(previewAsset)}
